...
/obj/item/paper/contractor_guide/Initialize()
	info = {"<p>Welcome agent, congratulations on your new position as contractor. On top of your already assigned objectives,
			...
			from where you sent them off from in several minutes time. We always get paid, and so will you.</p>

			<p>Good luck agent. We recommend you burn this document with the supplied lighter.</p>"}
